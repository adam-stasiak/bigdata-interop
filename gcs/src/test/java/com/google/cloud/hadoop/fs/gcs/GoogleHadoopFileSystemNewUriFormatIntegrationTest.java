...
public class GoogleHadoopFileSystemNewUriFormatIntegrationTest
  ...
  public void testGetGcsPath() throws URISyntaxException {
    ...
    assertThrows(
            IllegalArgumentException.class, () -> myghfs.getGcsPath(new Path("gs:///")));
  }
  ...
  public void testGcsLazyConfigurationEnabled() throws IOException, URISyntaxException {
    ...
    Configuration conf = loadConfig();
    conf.set(
            GoogleHadoopFileSystemConfiguration.GCS_LAZY_INITIALIZATION_ENABLE.getKey(),
            "true");
    URI initUri = new URI("gs://" + ghfsHelper.getUniqueBucketName("init"));
    ghfs.initialize(initUri, conf);
  ...
  public void testExceptionIsThrownDuringConfigurationWhenCannotCreateGcsFs()
    ...
    Configuration conf = loadConfig();
    conf.set(
            GCS_LAZY_INITIALIZATION_ENABLE.getKey(),
            "true");
    ...
    RuntimeException thrown =
            assertThrows(RuntimeException.class, () -> testInstance.getGcsFs());
