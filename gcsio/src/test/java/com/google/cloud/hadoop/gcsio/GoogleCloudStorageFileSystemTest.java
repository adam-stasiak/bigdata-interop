...
public class GoogleCloudStorageFileSystemTest
  ...
  public void testConstructor() throws IOException {
    ...
    optionsBuilder.getCloudStorageOptionsBuilder().setRequesterPaysOptions(RequesterPaysOptions.DEFAULT);
    ...
    assertThat(gcsfs.getOptions().getCloudStorageOptions().getRequesterPaysOptions()).isEqualTo(RequesterPaysOptions.DEFAULT);
  }
